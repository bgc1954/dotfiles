...
#define DMENU		"dmenu_run -fn \"-*-terminus-medium-r-*-*-14-*-*-*-*-*-*-*\" -nb \"#101010\" -nf \"#484862\" -sb \"#080808\" -sf \"#FFDD0E\""
...
/* key definitions */
#define KEY1 Mod1Mask
#define KEY2 Mod4Mask
...
static Key keys[] = {
	...
	/* launchers + misc: */
	{ KEY1|KEY4,			XK_Return,	spawn,		CMD(TERM)		},
	{ KEY1,				XK_x,		spawn,		CMD(DMENU)		},
	{ KEY1,				XK_w,		spawn,		CMD("~/bin/luakit.sh")	},
	{ KEY1,				XK_c,		spawn,		CMD("chromium")	},
	{ KEY1,				XK_p,		spawn,		CMD("pcmanfm")	},
	{ KEY1|KEY4,		        XK_q,		quit,		NULL			},
	{ KEY1,				XK_q,		killclient,	NULL			},
	{ KEY1,				XK_f,		fullscreen,	NULL			},
	{ KEY1,				XK_Menu,	windowlist,	"interrobang alopex"},
	{ KEY1|KEY2,			XK_f,		toggle,		"floating"		},
	{ KEY1,				XK_t,		toggle,		"place bar"		},
	...
	{ KEY1,				XK_Up,		tile,		"monocle"		},
	{ KEY1,				XK_Down,	tile,		"bstack"		},
